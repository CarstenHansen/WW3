...
!     !/MFIT   Extended tail Stokes drift (XSTO) with parameter fit  
!
!  7. Source code :
!
!/ ------------------------------------------------------------------- /
...
#ifdef W3_XSTO
! Definition of I, J for parameter 'XSP' here.
      INTEGER                         :: IXSP=6, JXSP=14
!/
#endif
!/ Data structures
!/
...
!     'Deep Stokes drift E., N., Mfit parameters AM, PM, AMd, PMd, QC, ITSIC'
#endif
